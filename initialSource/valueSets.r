###############################################################################
### valueSets() calculates value sets from responses to value questions
### Schwarz values analysis
### options :
### numQs = 21 : converts 21 welsh assembly values questions to 9 value sets
### numQs = 57 : full Schwartz values analysis
### numQs = dataframe : later allow user to submit their own lookup table

### returns a dataframe that can be plotted using rosePlot()
### andy south 25/7/2012
### package rschwartzvalues
###############################################################################
valueSets <- function( dFraw  #dataFrame or could be a text file 
