###############################################################################
### rosePlotMulti() to create rose plots for all of the specified columns in a passed dataframe

###! could add a default of ALL columns
### andy south 25/7/2012
### package rschwartzvalues
###############################################################################
rosePlotMulti <- function( dF  #dataFrame
